    ...
    <nav className="fixed w-full shadow z-50" style={{ backgroundColor: "#2B1B17" }}>
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6 font-medium text-white">
          ...
          {/* ⭐ 2. SPECIAL ANIMATED GAME BUTTON */}
          <Link 
            to="/game" 
            className="flex items-center space-x-2 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 text-white font-bold py-1 px-4 rounded-full shadow-lg transform transition duration-300 hover:scale-110 hover:shadow-orange-500/50"
          >
             {/* Bouncing Icon */}
            <Gamepad2 size={18} className="animate-bounce" />
            <span>Win Coupon!</span>
          </Link>
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden px-6 py-4 space-y-3" style={{ backgroundColor: "#596E65" }}>
          ...
          {/* ⭐ 3. GAME BUTTON FOR MOBILE */}
          <Link 
            to="/game" 
            onClick={() => setMobileOpen(false)} 
            className="flex items-center justify-center space-x-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-bold py-2 rounded-md animate-pulse"
          >
            <Gamepad2 size={20} />
            <span>Play & Win Coupon!</span>
          </Link>
